...
# 웹드라이버 생성
driver = webdriver.Chrome('C:\\Users\\No\\eclipse-workspace\\insta\\chromedriver')
...
for elt in driver.find_elements_by_class_name('post-list__post.post'):
    ...
    # 이미지 저장할 경로 정의
    img_path = 'C:\\Users\\No\\PycharmProjects\\python_intermediate\\14_selenium_package' + img_url.split('/')[-1]
